<script>
  ...
  .color-picked-bg {
    ...
    background-size: 10px 10px;
    background-position: 0 0, 0 5px, 5px -5px, -5px 0px;
    border: 2px solid var(--theme-input-color);
    border-radius: 4px;
    width: 18px;
    height: 18px;
    color: #fff;
  ...
  .hex-text-block {
    display: inline-block;
    background: var(--theme-input-color);
    border-radius: 2px;
    padding: 2px;
    height: 16px;
    width: 54px;
  ...
  --theme-color: {theme.toLowerCase() === 'dark' ? '#282828' : '#f2f2f2'};
  --theme-input-color: {theme.toLowerCase() === 'dark' ? '#484848' : '#FFF'};
  --theme-input-text-color: {theme.toLowerCase() === 'dark' ? '#AAA' : '#000'};
  --theme-input-border-color: {theme.toLowerCase() === 'dark' ? '#151515' : '#dcdcdc'};
  ">
